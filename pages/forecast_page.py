                    ...
                    [
                        dbc.Col(
                            [
                                ...
                                html.Div("Forecast basis", className="small fw-semibold"),
                                dbc.RadioItems(
                                    id="vs-phase2-basis",
                                    options=[
                                        {"label": "IQ Data (Contact Ratio × IQ)", "value": "iq"},
                                        {"label": "Volume (forecast volume directly)", "value": "volume"},
                                    ],
                                    value="iq",
                                    inline=True,
                                    className="di-radio mb-2",
                                    inputClassName="me-1",
                                    labelClassName="me-3",
                                ),
                    ...
                    dbc.Col(
                        dbc.Card(
                            [
                                ...
                                html.Div("Daily/interval group level", className="di-field-label"),
                                dbc.RadioItems(
                                    id="di-group-level",
                                    options=[
                                        {"label": "Forecast Group", "value": "forecast_group"},
                                        {"label": "Business Area", "value": "business_area"},
                                    ],
                                    value="forecast_group",
                                    inline=True,
                                    className="di-radio mb-2",
                                    inputClassName="me-1",
                                    labelClassName="me-3",
